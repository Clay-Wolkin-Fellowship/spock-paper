...
In each graph, any $(x,y)$ point corresponds to $y$ evictions that took $x$ thousand memory acceses to be recached.
...
\begin{figure}
\begin{center}
\includegraphics[width=\columnwidth]{{img/sp_omp.#2}.png}
\end{center}
